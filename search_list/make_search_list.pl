...
# 作法:
# 先讀取 ../TaishoMenu_b5.txt 及 ../XuzangjingMenu_b5.txt
...
make_vol("../TaishoMenu_b5.txt",3);	# "T", "大正藏", 最後一個參數是有幾層, 若有部別, 則有 3 層, 沒部的就二層
make_vol("../XuzangjingMenu_b5.txt",3); #"X", "新纂卍續藏", 
make_vol("../JiaXingZangMenu_b5.txt",2); #"J", "嘉興藏(新文豐版)", 
make_vol("../OthersMenu_b5.txt",2); #"", "補輯", 
make_vol("../ZangWaiMenu_b5.txt",2); #"W", "藏外佛教文獻", 
make_vol("../ZhengShiMenu_b5.txt",2); #"H", "正史佛教資料類編", 
make_vol("../BaiPinMenu_b5.txt",2); #"I", "北朝佛拓百品", 
close OUT;
